...
import { useFacultyCourses } from "@/admin/lib/hooks/use-faculty";
...
import { formatPercentage } from "@/admin/lib/utils/format";
import type { FacultyCourse } from "@/admin/lib/api/types/faculty.types";
