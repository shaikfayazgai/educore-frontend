...
import { useCredentials } from "@/admin/lib/hooks/use-student";
...
import type { Credential } from "@/admin/lib/api/types/student.types";
import type { CredentialStatus } from "@/admin/lib/api/types/common.types";
