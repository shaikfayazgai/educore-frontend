...
import { FormField, FormTextarea } from "@/admin/components/shared/forms/form-field";
...
import type { WorkExperience } from "@/admin/lib/api/types/student.types";
...
function ProfileTab({
  ...
  profile: import("@/admin/lib/api/types/student.types").StudentProfile;
}) {
...
interface NotifToggleItem {
  key: keyof import("@/admin/lib/api/types/student.types").NotificationPreferences;
  label: string;
  description: string;
}
...
function NotificationsTab({
  ...
  preferences: import("@/admin/lib/api/types/student.types").NotificationPreferences;
}) {
