...
import { useSuperAdminDashboard } from "@/admin/lib/hooks/use-super-admin";
...
import { formatNumber, formatRelative, formatCompact } from "@/admin/lib/utils/format";
...
function ChartTooltip({ active, payload, label }: any) {
  ...
  return (
    <div className="rounded-lg bg-card px-4 py-3 shadow-xl ring-1 ring-border/20">
      ...
      <p className="mt-1 font-mono text-lg font-bold">{payload[0].value} universities</p>
    </div>
  );
}
