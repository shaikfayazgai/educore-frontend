...
import { usePlatformMonitoring } from "@/admin/lib/hooks/use-super-admin";
...
export default function MonitoringPage() {
  ...
  if (isError || !data) return <div className="p-10"><ErrorState title="Failed to load monitoring data" message="Could not retrieve platform health data." onRetry={() => refetch()} /></div>;
