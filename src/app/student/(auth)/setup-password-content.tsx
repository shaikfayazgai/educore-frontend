    ...
    <div className="space-y-6">
      <div className="space-y-2">
        ...
        <p className="text-sm text-muted-foreground">
          {forced
            ? "Your account is using the default onboarding password. Pick a private one before continuing."
      ...
      <p className="text-center text-xs text-muted-foreground">
        Have your password? <Link href="/student/login" className="text-portal-accent hover:underline">Sign in</Link>
      </p>
    </div>
  );
}
