...
import { useAdminDashboard, useComplianceDeviations } from "@/superadmin/lib/hooks/use-admin";
...
import { StatusBadge, getComplianceVariant, getRiskVariant } from "@/superadmin/components/shared/feedback/status-badge";
...
import { formatNumber, formatPercentage, formatRelative } from "@/superadmin/lib/utils/format";
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <StatCard
          ...
          value={formatPercentage(data.retention.rate)}
          change={{ value: data.retention.trend, label: "vs last year" }}
          icon={Users}
        />
        <StatCard
