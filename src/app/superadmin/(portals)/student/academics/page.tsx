...
import { useCourses, useTranscript } from "@/superadmin/lib/hooks/use-student";
...
import { CardSkeleton, TableSkeleton } from "@/superadmin/components/shared/feedback/loading-skeleton";
...
import { formatGpa, formatPercentage } from "@/superadmin/lib/utils/format";
import type { Course, TranscriptSemester } from "@/superadmin/lib/api/types/student.types";
