...
export function Sidebar({ portalName, sections }: SidebarProps) {
  ...
  return (
    ...
    >
      ...
      >
        {/* The portal-accent gradient tile + GraduationCap stays as the
            collapsed/anchor mark — the new horizontal wordmark wouldn't
            fit at 32x32 and the per-portal color is a useful visual
            identifier. When expanded, the wordmark replaces the
            "Glimmora" text label so the brand is consistent everywhere. */}
        <div
