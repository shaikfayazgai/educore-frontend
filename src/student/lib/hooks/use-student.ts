...
import type {
  ...
  StudentCourseModule,
  AssignmentDetail,
} from "@/student/lib/api/types/student.types";
import type { PaginationMeta } from "@/student/lib/api/types/common.types";
...
export function useNotifications(params?: { status?: string; page?: number; pageSize?: number }) {
  ...
  return useQuery({
    ...
    // (assignment graded, material uploaded, attendance marked, etc.) without
    // a manual page refresh. Matches faculty/superadmin bell cadence.
